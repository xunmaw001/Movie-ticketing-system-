...
<body>
		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">新片预告管理</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active"><span>新片预告列表</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">新片预告列表</h3>							
							<div class="table-responsive mb-3" id="tableDiv">
								<div class="col-sm-12">
									...
									<input type="text" id="yanyuanSearch" class="form-control form-control-sm" placeholder="" aria-controls="tableId">
	...
	<script>
		...
		function search(){
			...
			if($('#yanyuanSearch').val() != null && $('#yanyuanSearch').val() != ''){
				searchForm.yanyuan ="%" +  $('#yanyuanSearch').val() + "%";
			}
		...
		function setDataRow(item,number){
			...
			var dianyingjieshaoCell  = document.createElement('td');
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("xinpianyugao/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
		...
		function crossTable(id,crossTableName){
			...
			window.sessionStorage.setItem('crossTableName',"xinpianyugao");
