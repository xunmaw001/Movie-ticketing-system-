						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<input id="shangyingshijian" name="shangyingshijian" class="form-control" v-model="ruleForm.shangyingshijian" readonly>
									</div>
									...
									<input id="fangyingshijian" name="fangyingshijian" class="form-control" v-model="ruleForm.fangyingshijian" readonly>
									</div>
									<div class="form-group col-md-6">
									<label>电影预告</label>
									...
									<input id="goupiaoxuzhi" name="goupiaoxuzhi" class="form-control" v-model="ruleForm.goupiaoxuzhi" readonly>
									</div>
									<div class="form-group col-md-6">
									<label>是否支付</label>
