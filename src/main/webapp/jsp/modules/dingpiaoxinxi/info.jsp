						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<input id="dingpiaodingdan" name="dingpiaodingdan" class="form-control" v-model="ruleForm.dingpiaodingdan" readonly>
									</div>
									<div class="form-group col-md-6">
									<label>电影名称</label>
									...
									<input id="zhifujiage" name="zhifujiage" class="form-control" v-model="ruleForm.zhifujiage" readonly>
									</div>
									<div class="form-group col-md-6">
									<label>用户账号</label>
