...
<body>
		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">订票信息管理</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active"><span>订票信息列表</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">订票信息列表</h3>							
								...
								<table id="tableId" class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th onclick="sort('dingpiaodingdan')">订票订单<i id="dingpiaodingdanIcon" class="fa fa-sort"></i></th>
											...
											<th onclick="sort('zhifujiage')">支付价格<i id="zhifujiageIcon" class="fa fa-sort"></i></th>
	...
	<script>
		...
		function setDataRow(item,number){
			...
			var dingpiaodingdanCell  = document.createElement('td');

						 dingpiaodingdanCell.innerHTML = item.dingpiaodingdan;


			row.appendChild(dingpiaodingdanCell);
			...
			var zhifujiageCell  = document.createElement('td');

						 zhifujiageCell.innerHTML = item.zhifujiage;


			row.appendChild(zhifujiageCell);
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("dingpiaoxinxi/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
		...
		function crossTable(id,crossTableName){
			...
			window.sessionStorage.setItem('crossTableName',"dingpiaoxinxi");
        ...
        function pay(id){
			...
			window.sessionStorage.setItem('tableName',"dingpiaoxinxi");
