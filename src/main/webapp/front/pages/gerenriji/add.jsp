		...
		<div id="app">
			...
			<div class="data-add-container">
				...
				<form class="layui-form layui-form-pane" lay-filter="myForm">
						...
						<div class="layui-input-block">
							<input v-model="detail.rijibiaoti" type="text" name="rijibiaoti" id="rijibiaoti" autocomplete="off" class="layui-input">
						</div>
					</div>
                                                                                                                                            <div class="layui-form-item" pane>
						...
						<div class="layui-input-block">
							<textarea name="rijineirong" id="rijineirong">请输入日记内容</textarea>
						</div>
					</div>
		...
		<script>
			...
			layui.use(['layer', 'element', 'carousel', 'http', 'jquery', 'form', 'upload', 'laydate','tinymce'], function() {
				...
				form.on('submit(*)', function(data) {
                    ...
                    // 数据校验
					                    					                                                                                                                                                                					                                                                                                                                                                					var rijineirong = tinymce.get('#rijineirong').getContent()
					data.rijineirong = rijineirong;
					...
					// 提交数据
					http.requestJson('gerenriji' + '/add', 'post', data, function(res) {
					 	layer.msg('提交成功', {
					 		time: 2000,
					 		icon: 6
					 	}, function() {
