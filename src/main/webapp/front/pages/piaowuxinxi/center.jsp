				...
				<div class="right-container">
					<form class="layui-form" lay-filter="myForm">
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" name="yanyuan" id="yanyuan" placeholder="演员" autocomplete="off" class="layui-input">
							</div>
						</div>
                                                                                                <div class="layui-form-item">
							<label class="layui-form-label">上映时间</label>
							<div class="layui-input-block">
								<input type="text" name="shangyingshijian" id="shangyingshijian" placeholder="上映时间" autocomplete="off" class="layui-input">
							</div>
						</div>
                                                                                                                                                                        <div class="layui-form-item">
							...
							<div class="layui-input-block">
								<select name="fangyingshijian" id="fangyingshijian">
									<option value="">请选择</option>
							...
							<div class="layui-input-block">
								<input type="text" name="yingyuandizhi" id="yingyuandizhi" placeholder="影院地址" autocomplete="off" class="layui-input">
							</div>
						</div>
                                                                                                <div class="layui-form-item">
