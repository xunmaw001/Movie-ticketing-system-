    ...
    <fieldset class="search-container" style="text-align: center;margin: 50px 0;">
      <form class="layui-form" style="margin: 10px 0;">
        ...
        <div class="layui-inline" style="margin-left: 30px;">
          ...
          <button v-if="isAuth('piaowuxinxi','新增')" @click="jump('../piaowuxinxi/add.jsp')" type="button" class="layui-btn btn-theme">
      ...
      <div class="box">
        <ul class="clearfix">
          <li v-for="(item,index) in dataList" v-bind:key="index">
            <a :href="'../piaowuxinxi/detail.jsp?id='+item.id">
              <figure>
                <img :src="item.haibao?item.haibao.split(',')[0]:''" width="410" height="272" />
              </figure>
              <h2>{{item.dianyingmingcheng}}</h2>
              <div class="div1">
                <b></b>
  ...
  <script>
    ...
    layui.use(['layer', 'element', 'carousel', 'laypage', 'http', 'jquery'], function() {
      ...
      function pageList() {
        ...
        if (jquery('#fangyingting').val()) {
          param['fangyingting'] = jquery('#fangyingting').val() ? '%' + jquery('#fangyingting').val() + '%' : '';
        }  
        // 获取列表数据
        http.request('piaowuxinxi/list', 'get', param, function(res) {
